      ...
      <div className="min-h-screen bg-white py-12">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
            ...
            <p className="text-gray-600 mb-8 text-lg">{error || 'The project you are looking for does not exist.'}</p>
            <Link
              to="/projects"
            ...
            <div className="flex flex-wrap gap-4">
              {project.github_url && (
                <a
                  ...
                  className="flex items-center px-8 py-4 bg-gray-900 text-white rounded-xl font-semibold hover:bg-gray-800 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
                >
