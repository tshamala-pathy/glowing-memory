...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Always show success message (for security, backend doesn't reveal if email exists)
      setSuccess(true);
    } catch (err) {
          ...
          {success && (
            <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start">
              ...
              <div className="text-green-800 text-sm">
                ...
                <p>If an account exists with this email, you will receive a link to reset your password.</p>
              </div>
            </div>
          )}
