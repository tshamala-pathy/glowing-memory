...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col justify-between p-10 lg:p-14 text-white">
          ...
          <div>
            ...
            <p className="text-slate-200 text-lg max-w-md leading-relaxed">
              Join hundreds of professionals who trust PathyCode for web development, digital solutions, and client project management.
            </p>
          </div>
      ...
      {/* Right: Form panel */}
      <div className="w-full md:w-1/2 lg:w-[45%] flex flex-col justify-center px-6 sm:px-10 py-12 bg-slate-50 lg:bg-white overflow-y-auto">
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg sm:shadow-xl border border-slate-100 p-6 sm:p-8">
            ...
            <div className="mt-6 pt-6 border-t border-slate-100">
              <p className="text-center text-sm text-slate-500 mb-4">Already have an account?</p>
              <Link
                to="/login"
